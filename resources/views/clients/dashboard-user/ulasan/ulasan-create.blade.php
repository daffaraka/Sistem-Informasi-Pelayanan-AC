...
@section('content-user-title', 'Beri Ulasan')
<style>
    .rating {
        display: flex;
        width: 100%;
...
<form action="{{ route('user.beriUlasan', $transaksi->id_transaksi) }}" method="POST">
    @csrf
    <div class="container">

        <div class="feedback">
            <div class="rating" >
                <input type="hidden" name="id_layanan" value="{{ $transaksi->Layanan->id_layanan }}">
        ...
        <div class="d-flex justify-content-center">
            <button class="btn btn-primary text-light mt-4 px-4" type="submit">Beri Ulasan</button>
