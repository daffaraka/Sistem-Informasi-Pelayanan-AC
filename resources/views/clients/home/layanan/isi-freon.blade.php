...
@section('title', 'Isi Freon')
@section('content')
    <div class="container p-5">
        <div class="row">
            <div class="col-lg-6">
                <h1 class="fw-bold text-uppercase">Isi Freon</h1>
                <form method="post" action="{{ route('buat_transaksi') }}">
                    ...
                    <div class="mb-3">
                        <div class="form-label"> Jam Kedatangan</div>
...
@push('script')
    <script>
        $('input[type=radio][name=type_rumah]').change(function() {
            if (this.value == 'Rumah') {
                $('input[type=number][name=biaya_jasa]').val(200000);
            } else if (this.value == 'Ruko') {
                $('input[type=number][name=biaya_jasa]').val(225000);
            } else if (this.value == 'Apartement') {
                $('input[type=number][name=biaya_jasa]').val(250000);
            }
        });
