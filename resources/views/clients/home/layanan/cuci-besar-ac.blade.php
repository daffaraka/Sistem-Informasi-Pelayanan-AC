...
@section('content')
    <div class="container p-5">
        <div class="row">
            <div class="col-lg-6">
                <h1 class="fw-bold text-uppercase">Cuci Besar Ac</h1>
                <form method="post" action="{{ route('buat_transaksi') }}">
                    @csrf
                    <div class="mb-3">
                        <div class="form-label">Jenis Jasa</div>
                        <input type="text" class="form-control" name="layanan" value="Cuci Besar Ac" readonly>
                    </div>
                    <div class="mb-3">
    ...
    <script>
        $('input[type=radio][name=type_rumah]').change(function() {
            if (this.value == 'Rumah') {
                ...
                $('input[type=number][name=biaya_jasa]').val(300000);
            } else if (this.value == 'Apartement') {
                $('input[type=number][name=biaya_jasa]').val(370000);
            }
        });
